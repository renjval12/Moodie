...
document.getElementById("form1").onsubmit = function () {
    ...
    if (total < 6) {
        ...
        movieDeets(31011, moviePoster1, movieOption1, movieDesc1)
        movieDeets(266856, moviePoster2, movieOption2, movieDesc2)
        movieDeets(4553, moviePoster3, movieOption3, movieDesc3)
    }

    if (total >= 6 && total < 9) {
        document.getElementById("personality-type").innerHTML = "ENFJ"
        movieDeets(31011, moviePoster1, movieOption1, movieDesc1)
        movieDeets(680, moviePoster2, movieOption2, movieDesc2)
        movieDeets(4518, moviePoster3, movieOption3, movieDesc3)

    }

    if (total >= 9 && total < 14) {
        document.getElementById("personality-type").innerHTML = "ESTJ"
        movieDeets(350, moviePoster1, movieOption1, movieDesc1)
        movieDeets(9400, moviePoster2, movieOption2, movieDesc2)
        movieDeets(106646, moviePoster3, movieOption3, movieDesc3)
    }
    if (total >= 13) {
        document.getElementById("personality-type").innerHTML = "ISFP"
        movieDeets(194, moviePoster1, movieOption1, movieDesc1)
        movieDeets(1360, moviePoster2, movieOption2, movieDesc2)
        movieDeets(339877, moviePoster3, movieOption3, movieDesc3)
    }
