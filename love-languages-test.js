...
document.getElementById("form1").onsubmit = function () {
    ...
    if (total < 6) {
        ...
        movieDeets(114, moviePoster1, movieOption1, movieDesc1)
        movieDeets(455207, moviePoster2, movieOption2, movieDesc2)
        movieDeets(164, moviePoster3, movieOption3, movieDesc3)
    }

    if (total >= 6 && total < 11) {
        document.getElementById("personality-type").innerHTML = "Acts of Service"
        movieDeets(393457, moviePoster1, movieOption1, movieDesc1)
        movieDeets(465914, moviePoster2, movieOption2, movieDesc2)
        movieDeets(4347, moviePoster3, movieOption3, movieDesc3)

    }

    if (total >= 11 && total < 16) {
        document.getElementById("personality-type").innerHTML = "Physical Affection"
        movieDeets(152584, moviePoster1, movieOption1, movieDesc1)
        movieDeets(376867, moviePoster2, movieOption2, movieDesc2)
        movieDeets(251, moviePoster3, movieOption3, movieDesc3)

    }
    if (total >= 16 && total < 21) {
        document.getElementById("personality-type").innerHTML = "Words of Affirmation"
        movieDeets(502147, moviePoster1, movieOption1, movieDesc1)
        movieDeets(31031, moviePoster2, movieOption2, movieDesc2)
        movieDeets(8055, moviePoster3, movieOption3, movieDesc3)
    }

    if (total >= 21) {
        document.getElementById("personality-type").innerHTML = "Quality Time"
        movieDeets(264644, moviePoster1, movieOption1, movieDesc1)
        movieDeets(9364, moviePoster2, movieOption2, movieDesc2)
        movieDeets(152601, moviePoster3, movieOption3, movieDesc3)
    }
